...
read -p "Please enter two numbers: " firstNumber secondNumber
...
fNum=$(expr $firstNumber % 2)
sNum=$(($secondNumber % 2))
mNum=$(($secondNumber % $firstNumber))
[ $fNum -gt 0 ] && echo "The first number is odd" || echo "The first number is even"
[ $sNum -gt 0 ] && echo "The second number is odd" || echo "The second number is even"
[ $mNum = 0 ] && echo "$secondNumber is a multiple of $firstNumber" || echo "$secondNumber is not a multiple of $firstNumber"
...
[ -n $USER ] && echo "Current logged in User: $USER"
[ -v $USER -a -z $USER ] && echo "USER variable exists, but is empty"
...
read -p "Enter two strings for comparison: " a b
